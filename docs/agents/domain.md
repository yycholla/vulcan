...
- `src/<area>/CONTEXT.md` — per-area domain notes (agent, daemon, extensions, gateway, hooks, provider, symphony, tools, tui).
...
│   ├── 0006-extension-details-replay-and-frontend-rendering.md
│   ├── 0007-extension-frontend-events-and-status-widgets.md
│   ├── 0007-symphony-workflow-contract.md
│   └── 0008-symphony-typed-config.md
└── src/
    ├── agent/
    │   └── CONTEXT.md
    ├── daemon/
