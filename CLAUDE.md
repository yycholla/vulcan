...
This project is indexed by GitNexus as **vulcan** (7140 symbols, 18671 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
