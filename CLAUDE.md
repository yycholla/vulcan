...
This project is indexed by GitNexus as **vulcan** (9419 symbols, 24017 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
