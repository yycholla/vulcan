...
This project is indexed by GitNexus as **vulcan** (8614 symbols, 22339 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
