...
//!
//! The daemon-side extension contributes three tools. Runtime wiring
//! prefixes them as `todo_add`, `todo_list`, and `todo_clear`; the
//! tool implementations expose local names `add`, `list`, and `clear`.
