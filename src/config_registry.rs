...
const BUILTIN_FIELDS: &[ConfigField] = &[
    ...
    ConfigField {
        ...
        kind: FieldKind::Bool,
        default: "false",
        help: "Enable shared Vulcan OpenTelemetry export for the current process.",
        file: ConfigFile::Config,
    },
    ConfigField {
        ...
        kind: FieldKind::String { secret: false },
        default: "(unset)",
        help: "Base OTLP/HTTP collector endpoint; derives /v1/traces and /v1/metrics.",
        file: ConfigFile::Config,
    },
    ConfigField {
        ...
        kind: FieldKind::Bool,
        default: "true",
        help: "Export tracing spans through OpenTelemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        ...
        kind: FieldKind::Bool,
        default: "true",
        help: "Export metrics through OpenTelemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        ...
        kind: FieldKind::Bool,
        default: "false",
        help: "Reserved for future OTel log export; structured tracing logs still work.",
        file: ConfigFile::Config,
    },
    ConfigField {
        ...
        kind: FieldKind::String { secret: false },
        default: "vulcan",
        help: "OpenTelemetry resource service.name value.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.export_interval_secs",
        kind: FieldKind::Int {
            min: Some(1),
            max: Some(3600),
        },
        default: "30",
        help: "Periodic OTel metrics export interval.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.surfaces.agent",
        kind: FieldKind::Bool,
        default: "true",
        help: "Emit agent/session telemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.surfaces.hooks",
        kind: FieldKind::Bool,
        default: "true",
        help: "Emit hook health and hook event telemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.surfaces.tools",
        kind: FieldKind::Bool,
        default: "true",
        help: "Emit tool-call telemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.surfaces.provider",
        kind: FieldKind::Bool,
        default: "true",
        help: "Emit provider/model request telemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.surfaces.daemon",
        kind: FieldKind::Bool,
        default: "true",
        help: "Emit daemon request/lifecycle telemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.surfaces.gateway",
        kind: FieldKind::Bool,
        default: "true",
        help: "Emit gateway message telemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    ConfigField {
        path: "observability.surfaces.symphony",
        kind: FieldKind::Bool,
        default: "true",
        help: "Emit Symphony/task orchestration telemetry when observability is enabled.",
        file: ConfigFile::Config,
    },
    // ── embeddings.* ──────────────────────────────────────────
    ConfigField {
